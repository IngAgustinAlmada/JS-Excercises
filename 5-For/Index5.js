...
var someWords, i;
someWords = ["Hola", "mi", "nombre", "es", "Agustin", "Almada", "y", "soy", "ingeniero", "civil"];
...
for (i = 0; i < someWords.length; i++) {
    if (someWords[i][0] !== someWords[i][0].toUpperCase()){
    someWords[i] = someWords[i][0].toUpperCase() + someWords[i].substring(1);
    alert(someWords [i]);
    }
}
